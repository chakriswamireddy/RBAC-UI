    ...
    <Link to='/users'  > Users </Link>
            ...
            <div className="navbar-center hidden lg:flex gap-10 flex-1  ">
                <ul className="menu menu-horizontal px-1 gap-4  ">
                    <li> <NavLink to='/' className={`${({ isActive }) => (isActive ? 'text-secondary' : ' ')} active:text-secondary focus:text-secondary transition ease-in-out delay-100 duration-300`} > Users </NavLink> </li>
