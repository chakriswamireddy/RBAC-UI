  ...
  return (
    <div className=' border-0 border-blue-400 self-center w-full sm:w-3/4 max-w-2xl    '>
      <div className="card md:card-side bg-base-200 shadow-xl w-full">
        ...
        <figure className=' w-full sm:max-w-52   sm:border-2 border-blue-400  object-fill'>
        ...
        <div className="card-body">
          <h1 className="card-title text-2xl underline underline-offset-1">Statistics</h1>
          ...
          <div className="card bg-base-100    h-12 sm:h-20  shadow-xl">
            <div className="card-body p-3 sm:p-7 ">
              <h2 className="card-title text-md sm:text-lg  "> Total Users : {usersData?.length} </h2>
            </div>
          </div>
          ...
          <div className='grid grid-cols-3 gap-0 justify-start'>
            ...
            <div className="card-body h-10 border-0 border-blue-500 p-3  ">
              <h2 className="card-title text-xs sm:text-lg  border-blue-500 p-0 text-center  "> {role}s : {statsData[role]} </h2>
            </div>
          </div>
